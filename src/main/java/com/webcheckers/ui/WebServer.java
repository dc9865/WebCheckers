...
public class WebServer {
  ...
  public static final String SIGNIN_URL="/getsignin";
  public static final String POSTSIGNIN_URL="/postsignin";
  public static final String POSTSIGNOUT_URL="/signout";
  public static final String POSTGAME_URL="/postgame";
  public static final String GAME_URL="/game";
  public static final String POSTRESIGN_URL="/resignGame";
  public static final String POSTVALIDATEMOVE_URL="/validateMove";
   ...
   *
   * @param sessions
   *    The HashMap object that maps a player's username to their Session in order
   *    to add attributes to a different thread/game
   *
  ...
  public void initialize() {
    ...
    // Gets the username
    post(POSTSIGNIN_URL, new PostSigninRoute(templateEngine, playerLobby, sessions));

    // Signs out the user
    post(POSTSIGNOUT_URL, new PostSignoutRoute(templateEngine, playerLobby, sessions));

    // Initiates a game
    post(POSTGAME_URL, new PostGameRoute(templateEngine, playerLobby, sessions));

    //Shows Game page
    get(GAME_URL, new GetGameRoute(templateEngine, playerLobby));

    // Resign route
    post(POSTRESIGN_URL, new PostResignRoute(templateEngine));

    post(POSTVALIDATEMOVE_URL, new PostValidateMoveRoute(templateEngine, playerLobby, gson));
    //
