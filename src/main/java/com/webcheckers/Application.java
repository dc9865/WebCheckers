...
public final class Application {
  ...
  public static void main(String[] args) {
    ...
    final HashMap<String, Session> sessions=new HashMap<String, Session>();

    // This application needs a player lobby to keep track of active players
    final PlayerLobby playerLobby = new PlayerLobby();

    // inject the game center and freemarker engine into web server
    final WebServer webServer = new WebServer(templateEngine, gson, playerLobby, sessions);
